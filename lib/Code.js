...
_debug( 'skipping import: ', classPath );
			},// _import
		...
		// TODO: getter/setters proper ?
			...
			if ( typeof addition == 'function'  ) {
                ...
                return function() {
                    ...
                    args = args.slice(0, -1);
_debug( className+'.'+propertyName+'( '+args+' )' );
			            var tmp = this._super;
